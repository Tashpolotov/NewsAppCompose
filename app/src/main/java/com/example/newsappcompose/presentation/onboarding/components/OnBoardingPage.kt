...
fun OnBoardingPagePreview() {
    NewsAppComposeTheme {
        OnBoardingPage(
            page = Page(
                title = "Lorem sdasdasddasdasdasdsa is simply dummy",
                description = "Lorem asdasdasdasdasdasdasdasdasdasdasdasdasdasdsa0 is simply dummy text of the printing and typesetting industry.",
